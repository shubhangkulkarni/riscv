module alu (input [31:0] rs1, input [31:0] rs2, input [31:0] imm, input [1:0] alu_op, input alu_src, input [2:0] funct3, input s, output reg [31:0] alu_result, output reg zero);
